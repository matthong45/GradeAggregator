...
if len(sys.argv) > 1:
    ...
    if not os.path.exists(input_file):
        ...
        print (usage)
        sys.exit(1)
# Else use the latest CS20*.xlsx file in the download folder; that is - the most recently exported TSK grading spreadsheet)
else:
    list_of_files = glob.glob(os.getenv("USERPROFILE") + r"\downloads\CS20*.xlsx")
